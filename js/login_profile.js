...
function logout() {
    ...
    document.getElementById('afterlog_info').style.display='none';
    document.getElementById('beforelog_info').style.display='block';
    document.getElementById('afterlog_upload').style.display='none';
    document.getElementById('beforelog_upload').style.display='block';
    document.getElementById('afterlog_buy').style.display='none';
    document.getElementById('beforelog_buy').style.display='block';
    document.getElementById('afterlog_sell').style.display='none';
    document.getElementById('beforelog_sell').style.display='block';        
}
